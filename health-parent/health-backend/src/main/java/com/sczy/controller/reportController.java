...
public class reportController {
    ...
    @Reference
    private com.sczy.service.setmealService setmealService;
    @Reference
    private com.sczy.service.reportService reportService;
    @RequestMapping("/getMemberReport")//会员数量折线图
    public Result getMemberReport(){
        Map<String,Object> map = new HashMap<>();
        List<String> months = new ArrayList();
        //计算过去12个月
        Calendar  calendar = Calendar.getInstance();
        calendar.add(Calendar.MONTH,-12);//前12个月时间
        for (int i = 0;i<12;i++){
    ...
    @RequestMapping("/getSetmealReport")//每个套餐预约人数饼形图
